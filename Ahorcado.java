...
public class ahorcado {
    ...
    public static void main(String[] args) {
        ...
        int vidas = 6;int aciertos = 0;
        String palabra;
        
        int tamaño;
        String opcion;
        int contador = 0;
        String[] palabras = new String[]{"anivia", "shyvana", "teemo", "warwick", "kayn", "ornn"};
        char[] respuesta;
        ...
        while (aciertos != tamaño && vidas != 0) {
            System.out.println("=========AHORCADO en Java:)==========          VIDAS="+vidas +" Aciertos= "+aciertos);
            dibujar(vidas);
            System.out.println("");
            for (int i = 0; i < tamaño; i++) {
